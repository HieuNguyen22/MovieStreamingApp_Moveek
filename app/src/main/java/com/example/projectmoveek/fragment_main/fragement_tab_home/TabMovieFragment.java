...
public class TabMovieFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_tab_movie, container, false);

        rcvRecommend = root.findViewById(R.id.rcv_movie_recommend);
        rcvPopular = root.findViewById(R.id.rcv_movie_popular);
        rcvNew = root.findViewById(R.id.rcv_movie_new);
