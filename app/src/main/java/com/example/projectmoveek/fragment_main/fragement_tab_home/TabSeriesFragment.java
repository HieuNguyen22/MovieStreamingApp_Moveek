...
public class TabSeriesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_tab_series, container, false);

        rcvRecommend = root.findViewById(R.id.rcv_series_recommend);
        rcvPopular = root.findViewById(R.id.rcv_series_popular);
        rcvNew = root.findViewById(R.id.rcv_series_new);
