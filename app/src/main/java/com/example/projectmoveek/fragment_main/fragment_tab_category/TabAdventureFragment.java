...
public class TabAdventureFragment extends Fragment {

    private RecyclerView rcvAdventure;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_category_adventure, container,false);

        rcvAdventure = root.findViewById(R.id.rcv_category_adventure);
    ...
    private void setRecyclerView() {
        ...
        rcvAdventure.setLayoutManager(gridLayoutManager);
        rcvAdventure.setAdapter(itemAdapter);
