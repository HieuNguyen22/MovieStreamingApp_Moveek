...
public class TabHorrorFragment extends Fragment {

    private RecyclerView rcvHorror;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_category_horror, container, false);

        rcvHorror = root.findViewById(R.id.rcv_category_horror);
    ...
    private void setRecyclerView() {
        ...
        rcvHorror.setLayoutManager(gridLayoutManager);
        rcvHorror.setAdapter(itemAdapter);
    }
