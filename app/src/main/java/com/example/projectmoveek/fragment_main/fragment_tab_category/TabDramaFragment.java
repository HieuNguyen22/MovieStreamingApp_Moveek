...
public class TabDramaFragment extends Fragment {

    private RecyclerView rcvDrama;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_category_drama, container,false);

        rcvDrama = root.findViewById(R.id.rcv_category_drama);
    ...
    private void setRecyclerView() {
        ...
        rcvDrama.setLayoutManager(gridLayoutManager);
        rcvDrama.setAdapter(itemAdapter);
