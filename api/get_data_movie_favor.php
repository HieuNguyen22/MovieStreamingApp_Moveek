...
$U_FID = $_POST['u_fid'];
// $U_FID = 'fyYXyVxYvsaclm4XRSkanGcpLAq2';

$query = "SELECT m.M_ID, m.M_TITLE, m.M_POSTER, m.M_YEAR, m.M_LENGTH, m.M_TYPE, m.M_GENRE, m.M_DESCRIPTION, m.M_TRAILER, m.M_IMDB FROM movie_table AS m, like_table AS l WHERE m.M_ID = l.M_ID AND l.U_FID = '$U_FID'";
